...
const sidebarMenu = [
...

  {
    ...
    icon: FiBriefcase,
    children: [
      { label: "Branch", path: "/admin/organization/branch" },
      { label: "Department", path: "/admin/organization/department" },
      { label: "Designation", path: "/admin/organization/designation" },
      {
        label: "Roles & Permissions",
        path: "/admin/organization/role-permission",
      },
    ],
  },

  {
    ...
    children: [
      ...
      { label: "Leave", path: "/admin/hr/leaves" },
      { label: "Shift", path: "/admin/hr/shift" },
      { label: "Holiday", path: "/admin/hr/holidays" },
...

  {
    ...
    children: [
      ...
      { label: "Live Tracking", path: "/admin/operations/live-tracking" },
    ],
  },
...
const AdminSidebar = ({ sidebarOpen, setSidebarOpen }) => {
  // tracks which group labels are expanded
  ...
  const toggleGroup = (label) => {
    // auto-open the sidebar if it's collapsed and a group is clicked
    if (!sidebarOpen) {
      setSidebarOpen(true);
