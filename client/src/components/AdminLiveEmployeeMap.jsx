  ...
  useEffect(() => {
    ...
    if (selectedEmployeeId) {
      ...
      if (employee?.location) {
        map.flyTo(
          [
            Number(employee.location.latitude),
            Number(employee.location.longitude),
          ],
          16,
          {
            animate: true,
...
const EmployeeMarker = ({
  ...
  // ====================================================
  // REAL-TIME LEAFLET POSITION UPDATE
  // ====================================================
  ...
  useEffect(() => {
    ...
    // Agar location actually change hui hai
    if (
...
const AdminLiveEmployeeMap = ({
  ...
  // IMPORTANT:
  // object nahi — sirf ID store karenge
