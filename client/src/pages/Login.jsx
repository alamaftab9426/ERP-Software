...
import { FaEnvelope, FaLock, FaEye, FaEyeSlash, FaShieldAlt, FaMapMarkerAlt } from "react-icons/fa";
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <label className="flex items-center gap-2 text-sm text-slate-600 cursor-pointer select-none">
              <input
                ...
                className="w-4 h-4 rounded border-slate-300 text-[#D9A94E] focus:ring-[#D9A94E]/40"
              />
            ...
            <button
              ...
              className="w-full py-2.5 rounded-lg bg-[#121A2E] text-white text-sm font-semibold
                hover:bg-[#1c2743] transition-colors shadow-sm"
            >
              Sign in
            </button>
          </form>
